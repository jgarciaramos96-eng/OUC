...
class ApplicationConfigurationTest {
    ...
    void corsMappingsAreConfiguredForFrontendOrigins() {
        ...
        when(registration.allowedOrigins(anyString(), anyString(), anyString(), anyString())).thenReturn(registration);
        ...
        verify(registration).allowedOrigins("http://localhost", "http://localhost:80", "http://localhost:8080", "http://localhost:5173");
