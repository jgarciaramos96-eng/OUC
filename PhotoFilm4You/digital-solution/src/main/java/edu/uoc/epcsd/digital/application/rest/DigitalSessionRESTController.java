...
public class DigitalSessionRESTController {
    ...
    @ResponseStatus(HttpStatus.OK)
    public List<DigitalSession> findDigitalSessionByUser(@RequestParam @NotNull String email) {
    ...
    public ResponseEntity<Long> createDigitalSession(@RequestBody @Valid CreateDigitalSessionRequest createDigitalSessionRequest) {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "The specified userId " + createDigitalSessionRequest.getEmail() + " does not exist.", e);
        }
    }
    ...
    public ResponseEntity<Boolean> updateDigitalSession(@PathVariable @NotNull Long digitalSessionId, @RequestBody @Valid CreateDigitalSessionRequest updateDigitalSessionRequest) {
        ...
        try {
            ...
            digitalSessionService.updateDigitalSession(digitalSessionId, updateDigitalSessionRequest.getEmail(), updateDigitalSessionRequest.getDescription());

            return new ResponseEntity<>(true, HttpStatus.OK);
        } catch (IllegalArgumentException e) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "The specified Id or UserId " + digitalSessionId +" / "+ updateDigitalSessionRequest.getEmail()+" does not exist.", e);
        }
    }
